...
export const MODERNIZATION_PHASES: readonly LifecyclePhaseDefinition[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      { number: '6', name: 'Govern', delivery: 'next', subStages: ['Architecture review', 'Security and compliance gates', 'Exceptions and decision rights', 'Audit trail'] },
      { number: '7', name: 'Prioritize', delivery: 'next', subStages: ['Value versus effort', 'Risk-based sequencing', 'Dependency optimization', 'Funding priority'] },
    ],
  },
  {
    number: 3,
    ...
    stages: [
      ...
      { number: '9', name: 'Define Target State', delivery: 'next', subStages: ['Target architecture', 'Platform and landing-zone patterns', 'Non-functional requirements', 'Migration and cutover design'] },
    ],
  },
  {
    number: 4,
