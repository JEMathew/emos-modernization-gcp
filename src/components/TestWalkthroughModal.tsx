...
const PRODUCT_TOUR_STEPS = [
  ...
  },
  {
    step: 6,
    stage: 'Govern',
    title: 'Apply human decision gates',
    icon: ShieldCheck,
    description: 'Review architecture, security, compliance and evidence gates before recording a human decision.',
    action: 'Approve only when all gates pass, or reject/request more evidence with a durable rationale.',
  },
  {
    step: 7,
    stage: 'Prioritize',
    title: 'Rank value against effort',
    icon: Layers,
    description: 'Use transparent value, effort, risk-reduction and dependency-confidence scoring to propose funding order.',
    action: 'Review the deterministic ranking and confirm the human funding decision.',
  },
  {
    step: 8,
    stage: 'Plan',
  ...
  {
    step: 10,
    stage: 'Define Target State',
    title: 'Approve the delivery baseline',
    icon: Route,
    description: 'Capture target architecture, platform patterns, non-functional requirements, migration, cutover and rollback controls.',
    action: 'Save a draft or approve the baseline only after evidence and governance gates pass. Execute remains Planned.',
  },
];
...
const TEST_CASES: TestCase[] = [
  ...
  {
    id: 'TC-02',
    title: 'Enterprise Workload Submission & Governed 6R Assessment',
    ...
    expectedResult: 'The governed reasoning service evaluates authorized evidence and outputs a Recommended 6R Disposition, Executive Rationale, Viable Alternatives, and Critical Risks.',
  },
  {
    id: 'TC-03',
  ...
  },
  {
    ...
    steps: [
      ...
      'Verify the governed reasoning service preserves earlier findings and explains the implications of new evidence.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Verify EMOS passes all 18 structured Enterprise DNA attributes into its server-side reasoning boundary.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Confirm evaluation metadata (expected_6r, expected_reason) is excluded from reasoning payloads.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Click "Direct Assess for Modernization" on an imported workload and verify the assessment saves under /users/{userId}/interactions.',
