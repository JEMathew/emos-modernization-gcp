...
Updated: 21 September 2026. Beta v2 narrated-demo release: commit `579b0ae25893d90be69dae6b3ffccc3021088756`, immutable tag `emos-beta-v2-narrated-demo-20260921`, CI run `35540767630`, Cloud Run revision `gemini-reflection-journal-00057-doz` at 100% traffic.
...
| 13 | Reproducible demo and truthful media | PASS | Higgsedit-origin real production captures remain labelled synthetic-data; the separate 79.417-second narrated/captioned 1080p walkthrough is versioned, hash-recorded and uses no fictional screens. The silent landing media remains unchanged | Keep capture/source records with submission artifacts |

## Release gate result

| Gate | Result |
|---|---|
| Git push and immutable tag | PASS — `579b0ae`, `emos-beta-v2-narrated-demo-20260921` |
| CI, Java 21 Firestore emulator and build | PASS — run `35540767630` |
...
| Cloud Run | PASS — `gemini-reflection-journal-00057-doz`, 100% traffic |
| Public smoke | PASS — landing, sandbox, learning, trust, `/app`, auth boundary and versioned narrated-MP4 headers |
...
| Rollback | READY, NOT USED — prior healthy `gemini-reflection-journal-media-perf-605d756`; retained baselines `gemini-reflection-journal-media-ed9afe2` and `gemini-reflection-journal-cache-b7915d4` |
