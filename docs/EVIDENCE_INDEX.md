...
## Beta v2 narrated walkthrough release — 21 September 2026

- Source/tag/CI: `579b0ae25893d90be69dae6b3ffccc3021088756` / `emos-beta-v2-narrated-demo-20260921` / [run `35540767630`](https://github.com/JEMathew/emos-modernization-gcp/actions/runs/35540767630), passing.
- Truthful media: `emos-beta-v2-product-demo-narrated-captioned-v1.mp4` is a 4,024,724-byte, 1920×1080 H.264 MP4 with SHA-256 `84132eb9f0d4418ee6bf1d300d7cae3da943dde949c888f13e512f1b16e2a15f`. Its only visuals are real EMOS captures with synthetic data; its 79.400-second Cillian narration is captioned with burned English Montserrat/black-outline captions.
- Candidate/live proof: Cloud Run revision `gemini-reflection-journal-00057-doz` passed at zero traffic and was promoted to 100%. Live `/`, `/learn`, `/sandbox`, `/trust`, `/app` and the MP4 returned `200`; the MP4 returned `video/mp4`, byte-range support and the expected content length; unauthenticated `POST /api/chat` returned `401`.
- Rollback: `gemini-reflection-journal-media-perf-605d756` was recorded healthy at 100% before promotion and remains retained at 0%. `gemini-reflection-journal-media-ed9afe2` and `gemini-reflection-journal-cache-b7915d4` remain additional retained baselines. No Firestore rules were changed or deployed.
